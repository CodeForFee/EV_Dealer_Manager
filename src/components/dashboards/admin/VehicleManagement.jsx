...
import { mockVehicles, mockVehicleTypes } from '../../../data/mockData'
        ...
        <Col md={3}>
          <Card className="ev-card">
            <Card.Body className="text-center">
              ...
              <h3 className="text-primary">{vehicles.length}</h3>
        ...
        <Col md={3}>
          <Card className="ev-card">
            <Card.Body className="text-center">
              ...
              <h3 className="text-success">{vehicles.filter(v => v.status === 'active').length}</h3>
        ...
        <Col md={3}>
          <Card className="ev-card">
            <Card.Body className="text-center">
              ...
              <h3 className="text-info">{new Set(vehicles.map(v => v.brand)).size}</h3>
          ...
          <Card className="ev-card">
            <Card.Body className="text-center">
              ...
              <h3 className="text-warning">
                {(vehicles.reduce((sum, v) => sum + v.listed_price, 0) / 1000000000).toFixed(1)}B
              </h3>
